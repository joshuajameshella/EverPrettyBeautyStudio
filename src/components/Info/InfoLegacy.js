          ...
          <BrowserView>
            <div style={styles.webInfo}>
              ...
              <div style={styles.textHolder}>
                ...
                <div style={styles.infoTextTitle}>{body_1}</div>
                <div style={styles.infoText}>
                  <div style={styles.infoList}>  The Gel Bottle Inc, Gel Polish Nails</div>
                  <div style={styles.infoList}>  The Gel Bottle Inc, Gel Nail Extensions</div>
                  <div style={styles.infoList}>  Footlogix Pedicure</div>
                  <div style={styles.infoList}>  Brazillian and Hollywood Female Intimate Waxing</div>
                  <div style={styles.infoList}>  All other Waxing treatments</div>
                  <div style={styles.infoList}>  Eyelash Tinting and Eyebrow Tinting</div>
                </div>
