...
class SwipableMenu extends Component {
  render() {
    return (
      <Paper style={{overflowX: 'hidden', overflowY : 'scroll', fontSize: '14px', maxHeight: 'calc(80vh - 40px)', paddingLeft: '10%', paddingRight: '10%'}}>

        <div style={{ fontSize: 30, fontFamily: 'Muli, sans-serif', marginTop: 40, marginBottom: 40 }}>Treatment List</div>
        ...
        <div style={{ position: 'relative', float: 'left', width: 100, marginTop: 30 }}></div>
